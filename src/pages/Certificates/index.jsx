...
const CertificatesPage = () => {
  ...
  const handleFeatureClick = (feature, idOrName, certificateNameIfOpenForm = '') => {
    let description = '🚧 ฟีเจอร์นี้ยังไม่ได้พัฒนา—แต่ไม่ต้องกังวล! คุณสามารถขอให้เพิ่มฟีเจอร์นี้ในข้อความถัดไปได้! 🚀';
    if (feature === 'openForm') {
        description = `🚧 ฟีเจอร์เปิดฟอร์มสำหรับงาน ID: ${idOrName} ("${certificateNameIfOpenForm}") ยังไม่ได้พัฒนา—แต่ไม่ต้องกังวล! คุณสามารถขอให้เพิ่มฟีเจอร์นี้ในข้อความถัดไปได้! 🚀`;
    } else if (feature === 'view') {
        description = `🚧 ฟีเจอร์ดูตัวอย่าง "${idOrName}" ยังไม่ได้พัฒนา—แต่ไม่ต้องกังวล! คุณสามารถขอให้เพิ่มฟีเจอร์นี้ในข้อความถัดไปได้! 🚀`;
    } else if (feature === 'downloadQr') {
        description = `🚧 ฟีเจอร์ดาวน์โหลด QR Code สำหรับ "${idOrName}" ยังไม่ได้พัฒนา—แต่ไม่ต้องกังวล! คุณสามารถขอให้เพิ่มฟีเจอร์นี้ในข้อความถัดไปได้! 🚀`;
    } else if (feature === 'pagination') {
        description = '🚧 ฟีเจอร์แบ่งหน้ายังไม่ได้พัฒนา—แต่ไม่ต้องกังวล! คุณสามารถขอให้เพิ่มฟีเจอร์นี้ในข้อความถัดไปได้! 🚀';
    }
